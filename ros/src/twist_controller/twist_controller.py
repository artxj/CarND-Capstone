...
class Controller(object):
    def __init__(self, *args, **kwargs):
        ...
        self.Ki_steering = .005
        self.Kd_steering = 1.0

        self.filter_steer = LowPassFilter(tau = 2, ts = 1)
        self.filter_throttle = LowPassFilter(tau = 2, ts = 1)
    ...
    def control(self, *args, **kwargs):
        ...
        acceleration = self.filter_throttle.filt(acceleration)
